"""
Note: This is a direct copy of the rpi-rf module, pip installing this module causes issues 
      due to its explicit installation of RPi.GPIO (which conflicts with the shim rpi-lgpio)
